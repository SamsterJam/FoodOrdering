...
CREATE POLICY "ALL for ALL Authed" ON "public"."order_items" TO "authenticated" USING (true);

CREATE POLICY "All Authenticated All Actions" ON "public"."orders" TO "authenticated" USING (true);
